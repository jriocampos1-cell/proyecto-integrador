...
try {
    ...
    $stmt = $pdo->prepare('SELECT l.nLoteID, i.cNombre AS cInsumo, l.cCodigoLote, l.nCantidadActual, l.dFechaIngreso, l.dVencimiento FROM TLotes l JOIN TInsumos i ON l.nInsumoID = i.nInsumoID WHERE l.nLoteID = :id');
    $stmt->execute([':id' => $id]);
    $lote = $stmt->fetch();
