...
try {
    ...
    $sql = 'SELECT s.nSolicitudID, u.cNombre AS cUsuario, s.eEstado, s.cMotivoRechazo, s.dFecha
            FROM TSolicitud s
            LEFT JOIN TUsuarios u ON s.nUsuarioID = u.nUsuarioID
            ORDER BY s.dFecha DESC';
    $stmt = $pdo->query($sql);
