...
try {
    ...
    $stmt = $pdo->query('SELECT nInsumoID, cInsumo, cCategoria, nStockActual, nStockMinimo, eUnidadMedida, eEstadoSemaforo FROM v_SemaforoStock ORDER BY cCategoria, cInsumo');
    $semaforo = $stmt->fetchAll();
